...
namespace ContactManagerApp.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        {
            returnUrl = returnUrl ?? Url.Content("~/User/Index"); // Redirect to user page after login
            ...
            if (result.Succeeded)
            {
                ...
                // Check if the user has the "BasicUser" role, if not, assign it
            ...
            else
            {
                ...
                // Populate Input fields with claims from external provider if available
        ...
        {
            returnUrl = returnUrl ?? Url.Content("~/User/Index"); // Redirect to user page after registration
